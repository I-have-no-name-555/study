/**
 * @author :Xuan
 * @date :Create in 2020/12/21 9:21
 * @description 第13题 罗马数字转整数 简单
 * @update
 */
public class RomanToInteger {
    ...
    public int romanToInt1(String s) {
        ...
        while (index < len) {
            if (s.indexOf(romans[romanIndex], index) == index) {
                toInt += nums[romanIndex];
                index += romans[romanIndex].length();
            } else
                romanIndex++;
        }
